...
/*
 * =====================================================================================================================
 * Forward declarations — pauli_exp
 * =====================================================================================================================
 */
...
int main(void) {
    ...
    RUN_TEST(test_pauli_from_str_n64);
    ...
    RUN_TEST(test_pauli_exp_z);
    RUN_TEST(test_pauli_exp_nondiaganal_X);
    RUN_TEST(test_pauli_exp_nondiaganal_Y);
    RUN_TEST(test_pauli_exp_nondiaganal_XX);
    RUN_TEST(test_pauli_exp_nondiaganal_YY);
    RUN_TEST(test_pauli_exp_nondiaganal_YYY);
    RUN_TEST(test_pauli_exp_nondiaganal_XYZ);
